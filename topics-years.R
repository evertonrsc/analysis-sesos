...
years <- rep(2013:2023, each=6)
numpapers <- c(6, 0, 2, 2, 1, 5, 
               4, 5, 1, 0, 4, 2, 
               5, 0, 0, 1, 1, 2, 
               0, 2, 2, 0, 2, 1, 
               1, 2, 2, 0, 2, 0, 
